...
function infoUpdateData_7(data_array, label_array, color_array) {
  info_chart_7_data.datasets['0'].data = data_array;
  info_chart_7_data.labels = label_array;
  info_chart_7_data.datasets['0'].backgroundColor = color_array;

  info_chart_7_start = info_chart_7_data.labels;
  info_chart_7_start_data = info_chart_7_data.datasets['0'].data;
  info_chart_7_start_colors = info_chart_7_data.datasets['0'].backgroundColor;
