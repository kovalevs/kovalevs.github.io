...
document.getElementsByClassName('text-red')[1].classList.add('fa-angle-right');
document.getElementsByClassName('text-red')[1].classList.add('text-grey-visible');
document.getElementsByClassName('text-red')[1].classList.remove('fa-dollar-sign');

document.getElementsByClassName('text-red')[3].classList.add('fa-angle-left');
document.getElementsByClassName('text-red')[3].classList.add('text-grey-visible');
document.getElementsByClassName('text-red')[3].classList.remove('fa-dollar-sign');

document.getElementsByClassName('text-red')[4].classList.add('fa-angle-left');
document.getElementsByClassName('text-red')[4].classList.add('text-grey-visible');
document.getElementsByClassName('text-red')[4].classList.remove('fa-dollar-sign');

document.getElementsByClassName('text-red')[6].classList.add('fa-angle-right');
document.getElementsByClassName('text-red')[6].classList.add('text-grey-visible');
document.getElementsByClassName('text-red')[6].classList.remove('fa-dollar-sign');

document.getElementsByClassName('text-red')[7].classList.add('fa-angle-right');
document.getElementsByClassName('text-red')[7].classList.add('text-grey-visible');
document.getElementsByClassName('text-red')[7].classList.remove('fa-dollar-sign');

document.getElementsByClassName('text-red')[8].classList.add('fa-angle-left');
document.getElementsByClassName('text-red')[8].classList.add('text-grey-visible');
document.getElementsByClassName('text-red')[8].classList.remove('fa-dollar-sign');

document.getElementsByClassName('text-red')[13].classList.add('fa-angle-left');
document.getElementsByClassName('text-red')[13].classList.add('text-grey-visible');
document.getElementsByClassName('text-red')[13].classList.remove('fa-dollar-sign');

document.getElementsByClassName('text-red')[16].classList.add('fa-angle-left');
document.getElementsByClassName('text-red')[16].classList.add('text-grey-visible');
document.getElementsByClassName('text-red')[16].classList.remove('fa-dollar-sign');

document.getElementsByClassName('text-red')[17].classList.add('fa-angle-left');
document.getElementsByClassName('text-red')[17].classList.add('text-grey-visible');
document.getElementsByClassName('text-red')[17].classList.remove('fa-dollar-sign');
...
document.getElementsByClassName('text-red')[9].classList.add('text-red-visible');
document.getElementsByClassName('text-red')[11].classList.add('text-red-visible');

document.getElementsByClassName('text-red')[2].classList.add('text-green-visible');
document.getElementsByClassName('text-red')[2].classList.remove('text-red');

document.getElementsByClassName('text-red')[0].classList.add('text-green-visible');
document.getElementsByClassName('text-red')[0].classList.remove('text-red');

document.getElementsByClassName('text-red')[10].classList.add('text-green-visible');
document.getElementsByClassName('text-red')[10].classList.remove('text-red');

document.getElementsByClassName('text-red')[12].classList.add('text-green-visible');
document.getElementsByClassName('text-red')[12].classList.remove('text-red');

document.getElementsByClassName('text-red')[8].classList.add('text-red-visible');
